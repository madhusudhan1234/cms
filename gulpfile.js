...
elixir(function(mix) {
    ...
    mix.copy('node_modules/eonasdan-bootstrap-datepicker/build/js/bootstrap-datetimepicker.min.js',elixir.config.publicPath + '/js/datepicker.js');
    mix.copy('node_modules/eonasdan-bootstrap-datepicker/src/sass/_bootstrap-datetimepicker.scss',elixir.config.publicPath + '/sass/datepicker.scss');
    ...
    mix.scripts([
       'jquery.js','bootstrap.js','datepicker.js','moment.js'
        , 'simplemde.js'
    ]);
